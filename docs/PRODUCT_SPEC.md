...
> Требования зафиксированы без изменений по исходному ТЗ
> («ТЗ_ Personal AI Inbox - интеллектуальный Telegram TODO.md») на этапе Prompt 0 — Project contract.
> При обнаружении расхождений между кодом и этим документом приоритет у этого документа.
